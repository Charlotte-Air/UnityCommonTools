...
public class Lang
{
    ...
    public static string Get(UINT32 wID)
    {
        string tblStr = GetStr(wID);
        if (tblStr == null)
        {
    ...
    public static string Get(UINT32 wID, object param1)
    {
        string tblStr = GetStr(wID);
        if (tblStr == null)
        {
        ...
        tblStr = string.Format(tblStr, param1.ToString());
        tblStr = CheckString(tblStr);
        return tblStr;
    }

    public static string Get(UINT32 wID, object param1, object param2)
    {
        string tblStr = GetStr(wID);
        if (tblStr == null)
        {
        ...
        tblStr = string.Format(tblStr, param1.ToString(), param2.ToString());
        tblStr = CheckString(tblStr);
        return tblStr;
    }


    public static string Get(UINT32 wID, object param1, object param2, object param3)
    {
        string tblStr = GetStr(wID);
        if (tblStr == null)
        {
        ...
        tblStr = string.Format(tblStr, param1.ToString(), param2.ToString(), param3.ToString());
        tblStr = CheckString(tblStr);
        return tblStr;
    }
    ...
    public static string Get(string Str)
    {
        ...
        string jsonStr = JsonManager.GetString(jsonObj);
    ...
    public static string GetStr(uint wID)
    {
        return string.Empty;
    }
}