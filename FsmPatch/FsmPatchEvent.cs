...
public class FsmPatchEvent
{
    ...
    /// 用户热更结束进入游戏
    /// </summary>
    public class UserHutUpdateEnd : IEventMessage
    {
        public static void SendEventMessage()
        {
            var msg = new UserHutUpdateEnd();
            UniEvent.SendMessage(msg);
        }
    }
    ...
    /// 用户無网络
    /// </summary>
    public class UserNoNetwork : IEventMessage
    {
        public static void SendEventMessage()
        {
            var msg = new UserHutUpdateEnd();
    ...
    /// 用户無网络重试
    /// </summary>
    public class UserTryCheckNetwork : IEventMessage
    {
        public static void SendEventMessage()
        {
            var msg = new UserHutUpdateEnd();
