...
public class UIDropdownEditor : SelectableEditor
{
    ...
    SerializedProperty m_Transferred;
    ...
    protected override void OnEnable()
    {
        ...
        m_Transferred = serializedObject.FindProperty("m_bTransferred");
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.PropertyField(m_Transferred);
