...
public class AtlasTool : EditorWindow
{
    ...
    ///                ... 
    /// </summary>
    private static string pathRoot = Application.dataPath + "/HotUpdateAssets/UI/image/";
    
    /// <summary>
    /// 图集存储路径
    /// </summary>Assets/CreateAtlas/Editor/Res/Textures
    private static string atlasStoragePath = "Assets/HotUpdateAssets/UI/Atlas/";
    ...
    public static void CreateAllSpriteAtlas()
    {
        ...
        foreach (DirectoryInfo item in info.GetDirectories())
        {
            ...
            UnityEngine.U2D.SpriteAtlas spriteAtlas = AssetDatabase.LoadAssetAtPath(atlasStoragePath + "/" +  spritefilePathName + ".spriteatlas", typeof(Object)) as UnityEngine.U2D.SpriteAtlas;
    ...
    private static UnityEngine.U2D.SpriteAtlas CreateSpriteAtlas(string atlasName)
    {
    ...
    static void UpdateAtlas(UnityEngine.U2D.SpriteAtlas atlas, string spriteFilePath)
    {
