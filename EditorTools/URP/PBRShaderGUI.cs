...
namespace UnityEditor
{
    internal class PBRShaderGUI : ShaderGUI
    {
        ...
        private static class Styles
        {
            ...
            public static GUIContent rim = EditorGUIUtility.TrTextContent("Rim", "Rim");
            public static GUIContent rimPower = EditorGUIUtility.TrTextContent("RimPower", "RimPower");
        ...
        public void FindProperties(MaterialProperty[] props)
        {
            ...
            maskColor = FindProperty("_MainColor", props);
        ...
        public void ShaderPropertiesGUI(Material material)
        {
            ...
            EditorGUI.BeginChangeCheck();
            {
                ...
                if (rim != null)
                    m_MaterialEditor.ShaderProperty(rim, Styles.rim);
                if (rimPower != null)
                    m_MaterialEditor.ShaderProperty(rimPower, Styles.rimPower);
        ...
        {
            m_MaterialEditor.TexturePropertySingleLine(Styles.albedoText, albedoMap, albedoColor, maskColor);
