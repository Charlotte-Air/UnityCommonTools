...
public class TweenAlpha : UITweener
{
	...
	{
		mCached = true;
		mRect = GetComponent<UnityEngine.UI.Graphic>();
		...
		if (mRect == null && mSr == null)
		{
			...
			if (mMat == null) mRect = GetComponentInChildren<UnityEngine.UI.Graphic>();
		}
	}
	...
	public float value
	{
		...
		{
			if (!mCached) Cache();
			if (mRect != null) return mRect.color.a;
