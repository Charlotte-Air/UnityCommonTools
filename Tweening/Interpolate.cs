 ...
 */
    ...
    */
     ...
     * using Catmull-Rom.
     */
    public static IEnumerable<Vector3> NewCatmullRom(Transform[] nodes, int slices, bool loop, float tension) {
        return NewCatmullRom<Transform>(nodes, TransformDotPosition, slices, loop, tension);
    }
     ...
     */
    public static IEnumerable<Vector3> NewCatmullRom(Vector3[] points, int slices, bool loop, float tension) {
        return NewCatmullRom<Vector3>(points, Identity, slices, loop, tension);
    }

    public static IEnumerable<Vector3> NewCatmullRom2(IList points, int slices, bool loop, float tension)
    {
        return NewCatmullRom<Vector3>(points, Identity, slices, loop, tension);
    }
     ...
     * function directly.
     */
    static IEnumerable<Vector3> NewCatmullRom<T>(IList nodes, ToVector3<T> toVector3, int slices, bool loop, float tension) {
        // need at least two nodes to spline between
        if (nodes.Count >= 2) {
